...
public class ShipView extends EntityView {
     ...
     */
    public ShipView(com.pj.game.PlainJump game) {
        super(game);
    }
     ...
     */
    private TextureRegion createNotAcceleratingRegion(com.pj.game.PlainJump game) {
     ...
     */
    private Animation<TextureRegion> createAcceleratingAnimation(com.pj.game.PlainJump game) {
